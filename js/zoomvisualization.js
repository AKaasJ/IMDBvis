...
//        console.log(a.index + "," + b.index + " = " + linkedByIndex[a.index + "," + b.index]);
    ...
    var first_time = true; // hack for initializing the links
    function threshold(thresh) {
        ...
        // rebuild the linkedByIndex LUT
        //linkedByIndex.splice(0, linkedByIndex.length);
        linkedByIndex={};
        //console.log(graphRec.links);
